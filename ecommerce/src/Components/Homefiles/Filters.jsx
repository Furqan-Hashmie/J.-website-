...
const Filters = () => {
  ...
  const [allclothes, setAllclothes] = useState(mensclothing);
  const [prodata, setProdata] = useState(mensclothing);
...
const filtercolor = (curitem) => {
 ...
 <button className=" bg-gray-400 p-3 rounded">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Mens Kurta')}>Mens Kurta</Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Kurti')} className="w-72">Women Kurti</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button onClick={()=>filterproduct('Kids Girls')}>Kids Girls</Button>
                  </li>
                  <li>
                    <Button onClick={()=>filterproduct('Kids Boys')} className="w-40">Kids Boys</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72" onClick={()=>filterproduct('New Arrivals Infants')}>New Arrivals Infants</Button>
                  ...
                  <div className="pt-6" id="filter-section-0">
                    ...
                    <div className="flex items-center">
                      ...
                      <button className="w-6 h-6 rounded-full bg-green-500" />
                        <label htmlFor="filter-color-4" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
  ...
  <Link to={`/filters/${x.id}`}>
  <div className="relative cursor-pointer">
          <img className="w-full h-64 object-cover scale-110" src={x.image} alt="Placeholder Image" />
        </div> 
  </Link>
