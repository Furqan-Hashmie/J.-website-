...
import kidsboys from "../../Api/kidsboysapi"
...
const Kidsboys = () => {
  ...
  const [allclothes, setAllclothes] = useState(kidsboys);
  const [prodata, setProdata] = useState(kidsboys);
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/kidsboys" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Kids Boys</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Kids Boys</h1>
                  {/* search bar */}
 <div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Kids Cotton Kurta')}>Cotton Kurta</Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Kids Blended Kurta')} className="w-72">Blended Kurta</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button>Kids Silk Kurta</Button>
                  </li>
                  <li>
                    <Button >Suiting Kurta</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72" onClick={()=>filterproduct('Kids Lawn Kurta')}>Lawn Kurta</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-gray-700 cursor-pointer" />
                        <label htmlFor="filter-color-3" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Grey')}>Grey</label>
                      </div>
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-purple-600 cursor-pointer" />
                        <label htmlFor="filter-color-5" className="ml-2 mt-0.55 text-sm text-gray-900 cursor-pointer"
