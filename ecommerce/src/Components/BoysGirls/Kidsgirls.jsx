...
const Kidsgirls = () => {
  ...
  const [allclothes, setAllclothes] = useState(kidsgirls);
  const [prodata, setProdata] = useState(kidsgirls);
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/boygirls" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Boys&Girls Collection</Link>
      </div>
    </li>
    <li>
      <div className="flex items-center">
        ...
        <Link to="/kidsgirls" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Kids Girls</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Kids Girls</h1>
              {/* search bar */}
 <div>
 <button className=" bg-gray-400 p-3 rounded">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Girls Silk Lawn 3PC')}>Silk Lawn 3PC</Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Girls Poly-cotton 3PC')} className="w-72">Poly-cotton 3PC</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button>VELVET 3PC</Button>
                  </li>
                  <li>
                    <Button onClick={()=>filterproduct('Girls Jaquard 3PC')}>Girls Jaquard 3PC</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72" onClick={()=>filterproduct('Girls Silk Raw 3PC')}>Silk Raw 3PC</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    <div className="space-y-4 font-bold">
                      ...
                      <div className="flex items-center">
                        <button className="w-6 h-6 rounded-full bg-blue-700 cursor-pointer" />
                      ...
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-purple-600 cursor-pointer" />
                        <label htmlFor="filter-color-5" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Purple')}>Purple</label>
                      </div>
                      <div className="flex items-center">
        ...
        if(search==""){
          ...
          return x
            ...
            .map((x)=>{
                return(
                 <>
    <div className="relative m-10 w-72 max-w-xs overflow-hidden rounded-lg bg-white shadow-md">
      <Link to={`/kidsgirls/${x.id}`}>
  ...
  <div className="mt-4 px-5 pb-5">
    ...
    <div className="mt-2.5 mb-5 flex items-center">
      ...
      <svg aria-hidden="true" className="h-5 w-5 text-yellow-700" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
