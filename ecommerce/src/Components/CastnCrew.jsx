...
import castcrew from "../Api/castcrewapi"
...
const CastnCrew = () => {
  ...
  return (
    ...
    <section className="text-gray-600 body-font font-extrabold mt-9">
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/cast" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Cast & Crew</Link>
      </div>
    </li>
       {/* search bar */}
 <div className="ml-64">
...
<section className="text-gray-600 body-font">
  <div className="container px-5 py-10 mx-auto">
    <div className="flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4">
     ...
     .map((x)=>{
      return(
        <div className="p-2 w-96 sm:mb-0 mb-6 bg-white shadow-gray-300 shadow-xl hover:shadow-gray-700 mt-5 mx-5 rounded-2xl" key={x.id}>
       <Link to="#">
       <div className="rounded-lg  overflow-hidden">
          <img alt="content" className=" h-[27.5rem] w-full pt-3" src={x.image} />
        </div>
       </Link>
        <h2 className="text-xl font-bold text-center title-font text-gray-900 p-3">{x.title}</h2>
      </div>
      )
     })}
    </div>
