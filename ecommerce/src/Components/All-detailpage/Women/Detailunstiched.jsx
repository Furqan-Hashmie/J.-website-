...
const Detailunstiched = () => {
  const dispatch =useDispatch();
  const addcart = (x)=>{
  dispatch(add(x))
 }
  const [detail, setDetail] = useState(unstichedwomen)
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div className="md:flex-1 px-2">
          ...
          <img className="w-32 h-32 me-3 object-cover rounded-lg" src={res.image} alt="Product Image" />
          <img className="w-32 h-32  me-3 object-cover rounded-lg" src={res.image} alt="Product Image" />
...
export default Detailunstiched