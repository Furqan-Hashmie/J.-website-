...
import mensclothing from "../../../Api/mensclothesapi";
...
const Homedetail = () => {
  ...
  const [detail, setDetail] = useState(mensclothing)
    ...
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <div className="md:flex-1 px-2">
          ...
          <img className="w-32 h-32 me-3 object-cover rounded-lg" src={res.imagelarge} alt="Product Image" />
          <img className="w-32 h-32  me-3 object-cover rounded-lg" src={res.imagelarge} alt="Product Image" />
          <img className="w-32 h-32 object-cover rounded-lg" src={res.imagelarge} alt="Product Image" />
            </div>
        </div>
        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-3">{res.title}</h1>
        <p className="w-96 text-black dark:text-gray-300 font-medium text-xl mb-3">
          ...
          <div className="flex mt-6">
            <span className="font-bold text-2xl text-black dark:text-gray-300">Product Code:</span>
            <p className="text-gray-600 dark:text-gray-300 text-xl font-bold mt-0.5 ml-10">
             {res.productcode}
            </p>
          </div>
          <div className="mb-6 mt-5 flex items-center">
            <span className="font-bold text-black text-2xl ">Select Color:</span>
          ...
          <div className="flex">
            <span className="font-bold text-black text-2xl dark:text-gray-300">Select Size:</span>
            <div className="flex items-center mb-2 ml-14">
              <button className="bg-gray-300 text-gray-900 dark:text-white py-1.5 px-3.5 rounded-full font-bold mr-2 hover:bg-gray-400">S</button>
              <button className="bg-gray-300 text-gray-900 dark:text-white py-1.5 px-3 rounded-full font-bold mr-2 hover:bg-gray-400 ">M</button>
              <button className="bg-gray-300  text-gray-900 dark:text-white py-1.5 px-3 rounded-full font-bold mr-2 hover:bg-gray-400 ">L</button>
              <button className="bg-gray-300  text-gray-900 dark:text-white py-2 px-3 rounded-full font-bold mr-2 hover:bg-gray-400 ">XL</button>
          ...
          <div className="flex mt-5">
            <div className="mr-4 me-5">
              ...
              <span className="text-gray-900 text-2xl font-bold ml-10">{res.price} PKR</span>
            </div>
            
          </div>
          <div className="flex mt-5">
            <div className="mr-4 me-5">
              <span className="font-bold text-black text-2xl">Product code</span>
              <span className="text-gray-900 text-2xl font-bold ml-10">{res.productcode} </span>
            </div>
