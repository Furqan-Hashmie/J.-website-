...
const Onlinedetail = () => {
  ...
  const [detail, setDetail] = useState(onlineedition)
  ...
  return (
   <div>
  {/* component */}
  <section className="text-gray-700 body-font overflow-hidden bg-gray-100 mr-5 ml-10 mt-20 mb-20 rounded-3xl cursor-pointer">
    <div className="container px-5 py-24 mx-auto">
      <div className="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        <p className="w-96 text-black dark:text-gray-300 font-medium text-xl mb-3">
          ...
          <div className="flex -mx-2 mb-4 mt-10 cursor-pointer">
            <div className="w-60 px-2">
              <button className="w-full bg-gray-900 dark:bg-gray-600 text-white py-2 px-5 rounded-full font-bold hover:bg-gray-800 dark:hover:bg-gray-700 cursor-pointer" onClick={()=>addcart(res)}>Add to Cart</button>
            </div>
            <div className="w-60 px-2">
            <Link to="/online">
