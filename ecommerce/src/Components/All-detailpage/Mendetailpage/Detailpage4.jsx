...
const Detailpage4 = () => {
  ...
  dispatch(add(x))
    ...
    const [detail, setDetail] = useState(menfragrances)
  ...
  <div className="container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    enlargedImagePosition:"over"
        ...
        <img className="w-32 h-32 me-2 object-cover" src={res.imagehover} alt="Product Image" />
        <img className="w-32 h-32 me-2 object-cover" src={res.imagehover} alt="Product Image" />
        <img className="w-32 h-32 object-cover" src={res.imagehover} alt="Product Image" />
          </div>
      </div>
      <div className="md:flex-1 pl-20">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">Title : {res.title}</h2>
        ...
        <div className="flex">
          <div className="mr-4 me-5 mb-2">
            <span className="font-bold text-black text-2xl dark:text-gray-300">Price:</span>
            <span className="text-gray-900 text-xl font-bold ml-4">{res.price} PKR</span>
          </div>
