...
const Detailpage3 = () => {
  ...
  const [detail, setDetail] = useState(menswaiscoat);
  ...
  <div className="container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    enlargedImagePosition:"over"
        ...
        <img className="w-32 h-32 me-2 object-cover rounded-lg" src={res.imagehover} alt="Product Image" />
        <img className="w-32 h-32 me-2 object-cover rounded-lg" src={res.imagehover} alt="Product Image" />
      ...
      <div className="md:flex-1 pl-20">
        ...
        <div className="flex">
          <div className="mr-4 me-5 mb-2">
            ...
            <span className="text-gray-600 text-xl font-bold ml-4">{res.price}</span>
          </div>
