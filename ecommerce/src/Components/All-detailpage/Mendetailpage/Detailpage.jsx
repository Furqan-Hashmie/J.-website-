...
const Detailpage = () => {
  ...
  dispatch(add(x))
    ...
    const [detail, setDetail] = useState(menskurta)
    ...
    <div className="container max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      enlargedImagePosition:"over"
          ...
          <img className="w-32 h-32 me-2 object-cover rounded-lg" src={res.image} alt="Product Image" />
          <img className="w-32 h-32 me-2 object-cover rounded-lg" src={res.image} alt="Product Image" />
          <img className="w-32 h-32 object-cover rounded-lg" src={res.image} alt="Product Image" />
            </div>
        </div>
