...
import menskurta from "../../Api/menskurtaapi"
...
const Menkurta = () => {
  ...
  const [allclothes, setAllclothes] = useState(menskurta);
  const [prodata, setProdata] = useState(menskurta);
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/menkurta" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Men Kurta</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Mens Kurta</h1>
               {/* search bar */}
 <div>
 <button className=" bg-gray-400 p-3 rounded">
    <div className="relative mx-auto  text-gray-600">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" >Formal Shalwar Kameez  </Button>
                  </div>
                  </li>
                  <li>
                  <Button   className="w-72">Exclusive Shalwar Kameez</Button>
                  </li>
                  <li>
               ...
               <li>
                  ...
                  <li>
                  <Button className="w-72" >Casual Shalwar Kameez</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    ...
                    <btn onClick={setFilter} className="bg-gray-400 p-2 px-32 rounded-lg cursor-pointer">Reset</btn>
                      <div className="flex items-center">
      ...
      <div className="ordernow flex flex-row justify-between items-center w-full mt-3">
        ...
        <p className="btun4 lg:inline-flex items-center gap-3 group-hover:bg-black  group-hover:text-white bg-secondary-600 shadow-[10px_10px_150px_#ff9f0d] cursor-pointer py-2 px-4 text-sm font-semibold rounded-full butn" onClick={()=>addcart(b)}>
          Add to Cart
        </p>
      </div>
    </div>
