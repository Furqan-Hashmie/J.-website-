...
const KameezShalwar = () => {
  ...
  const [allclothes, setAllclothes] = useState(kameezshalware);
  const [prodata, setProdata] = useState(kameezshalware);
...
const filtercolor = (curitem) => {
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/kameez" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Men Shalwar Kameez</Link>
      </div>
    </li>
      ...
      <div>
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Men Shalwar Kameez</h1>
            {/* search bar */}
 <div>
 <button className=" bg-gray-400 p-3 rounded">
    <div className="relative mx-auto  text-gray-600">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Mens Kameez Shalwar Formal')}>Formal Shalwar Kameez  </Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Mens Kameez Shalwar Exclusive')} className="w-72">Exclusive Shalwar Kameez</Button>
                  </li>
                  <li>
               ...
               <li>
                  ...
                  <li>
                  <Button className="w-72" onClick={()=>filterproduct('Mens Kameez Shalwar Casual')}>Casual Shalwar Kameez</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    <div className="space-y-4 font-bold">
                      ...
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-yellow-600 dark:bg-gray-200 " />
                        <label htmlFor="filter-color-2" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Yellow')}>Yellow</label>
                      </div>
                      <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-green-800 " />
                        <label htmlFor="filter-color-4" className="ml-2 mt-0.5 text-md text-gray-900"
                      ...
                      <button className="w-6 h-6 rounded-full bg-gray-300 " />
                        ...
                        onClick={()=>filtercolor('White')}>White</label>
                      </div>
              ...
              {/* Product grid */}
              <div className="grid grid-cols-3 col-span-3 transition-all duration-2000">
      ...
      .map((x)=>(
                <div className="relative m-10 w-72 max-w-sm   rounded-lg  bg-white shadow-xl hover:shadow-gray-700" key={x.id}>
          <Link to={`/kameez/${x.id}`}>
          <div className="relative cursor-pointer">
          <img className="w-full h-64 object-cover rounded-xl transition duration-300 ease-in-out transform hover:scale-110" src={x.image} alt="Placeholder Image" />
          <img className="absolute top-0 left-0 w-full h-full rounded-xl object-cover transition duration-300 ease-in-out opacity-0 hover:opacity-100" src={x.imagehover} alt="Hover Image" />
        </div>
          </Link>
        ...
        30% OFF
                    ...
                    <div className="mt-4 px-5 pb-5">
                        <div className="mt-2.5 mb-2 flex items-center">
                            ...
                            <svg aria-hidden="true" className="h-5 w-5 text-yellow-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <p>
                            <h5 className="text-lg font-bold mb-2 tracking-tight text-slate-900">{x.title}</h5>
                        </p>
                        ...
                        <div className="items-center w-60 mt-6 cursor-pointer" onClick={()=>addcart(x)}>
                           
                        <div className="flex items-center justify-center text-center mt-7 cursor-pointer">
      <a  className="flex items-center text-center rounded-md bg-red-700 px-5 py-2.5 w-56 text-sm font-medium text-white hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-blue-300" onClick={()=>addcart(x)}>
