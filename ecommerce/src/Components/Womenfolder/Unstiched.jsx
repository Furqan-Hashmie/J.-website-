...
import unstichedwomen from "../../Api/unstichedwomendata"
...
const Unstiched = () => {
  ...
  const [allclothes, setAllclothes] = useState(unstichedwomen);
  const [prodata, setProdata] = useState(unstichedwomen);
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        <svg className="w-6 h-6 text-gray-400" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fillRule="evenodd" d="M'7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clipRule="evenodd" />
        </svg>
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/unstiched" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Women Unstiched</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Women Unstiched</h1>
                {/* search bar */}
 <div>
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Unstitched 1PC')}>Unstitched 1PC</Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Unstitched 2PC')} className="w-72">Unstitched 2PC</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button onClick={()=>filterproduct('Unstitched 3PC')}>Unstitched 3PC</Button>
                  </li>
                  <li>
                    <Button>Unstiched Trouser</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72">Unstiched Saree</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-brown-400 dark:bg-gray-200 " />
                        <label htmlFor="filter-color-1" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
