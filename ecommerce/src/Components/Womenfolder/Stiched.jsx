...
import stitched from "../../Api/stitchedapi"
...
const Stiched = () => {
  ...
  const [allclothes, setAllclothes] = useState(stitched);
  const [prodata, setProdata] = useState(stitched);
...
const filtercolor = (curitem) => {
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/stiched" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Women Stiched</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Women Stiched</h1>
               {/* search bar */}
            {/* search bar */}
 <div>
    ...
    <div className="relative mx-auto  text-gray-600">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Women Stitched 1PC')}>Unstitched 1PC</Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Women Stitched 2PC')} className="w-72">Unstitched 2PC</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button onClick={()=>filterproduct('Women Stitched 3PC')}>Unstitched 3PC</Button>
                  </li>
                  <li>
                    <Button>Stiched Trouser</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72">Stiched Saree</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    <div className="space-y-4 font-bold">
                      <div className="flex items-center">
                        <input id="filter-color-0" name="color[]" defaultValue="black" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"
                         />
                        <label htmlFor="filter-color-0" className="ml-3 text-md text-gray-900 cursor-pointer"
                          onClick={()=>filtercolor('Black')}
                        >Black</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-color-1" name="color[]" defaultValue="Multicolor" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-color-1" className="ml-3 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Multicolor')}>Multi-Color</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-color-2" name="color[]" defaultValue="Red" type="checkbox" defaultChecked className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-color-2" className="ml-3 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Red')}>Red</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-color-3" name="color[]" defaultValue="BLUE" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-color-3" className="ml-3 text-md text-gray-900"
                        onClick={()=>filtercolor('Blue')}>Blue</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-4" className="ml-3 text-md text-gray-900"
                        onClick={()=>filtercolor('Green')}>Green</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-color-5" name="color[]" defaultValue="Brown" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500"  />
        ...
        if(search==""){
          ...
          return x
                ...
                return(
                 <>
                 <div className="m-3 group px-10 py-5 bg-gray-50 rounded-lg flex flex-col items-center justify-center gap-2 relative after:absolute after:h-full after:bg-gray-300 z-20  after:-z-20 after:w-full after:inset-0 after:rounded-lg transition-all duration-300 hover:transition-all hover:duration-300 after:transition-all after:duration-500 after:hover:transition-all after:hover:duration-500 overflow-hidden cursor-pointer after:-translate-y-full after:hover:translate-y-0 [&_p]:delay-200 [&_p]:transition-all shadow-xl hover:shadow-gray-700">

    <Link to={`/stiched/${b.id}`}>
      <div className="relative cursor-pointer">
       <img className="w-full h-64 object-cover transition duration-300 ease-in-out transform hover:scale-110  border-2 border-gray-900 rounded-xl" src={b.image} alt="Placeholder Image" />
 ...
 <div className="mt-2 mb-1 flex items-start mr-14">
...
<p className="btun4 lg:inline-flex items-center gap-3 group-hover:bg-black  group-hover:text-white bg-red-500 text-white shadow-[10px_10px_150px_#ff9f0d] cursor-pointer py-2 px-4 text-sm font-semibold rounded-xl butn" onClick={()=>addcart(b)}>
  Add to Cart
</p>
</div>
</div>
