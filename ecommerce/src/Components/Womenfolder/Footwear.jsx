...
import womenfootwear from "../../Api/womenfootwear"
...
const Footwear = () => {
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/footwear" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Women Footware</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Women Footware</h1>
               {/* search bar */}
               {/* search bar */}
 <div>
 <button className=" bg-gray-400 p-3 rounded">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                  <li>
                    <a href="#">Bridal Khussa</a>
                  </li>
                  <li>
                    <a href="#">Multani Khussa</a>
                  </li>
                  <li>
                    <a href="#">Leather Khussa</a>
                  </li>
                  <li>
                    <a href="#">Walwet Khussa</a>
                  </li>
                  <li>
                    <a href="#">Embroidered Khussa</a>
                  </li>
                </ul>
                  ...
                  <div className="pt-6" id="filter-section-0">
                    <div className="space-y-4 font-bold">
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-0" className="ml-3 text-md text-gray-900">White</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-1" className="ml-3 text-md text-gray-900">Beige</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-2" className="ml-3 text-md text-gray-900">Blue</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-3" className="ml-3 text-md text-gray-900">Brown</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-4" className="ml-3 text-md text-gray-900">Green</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-color-5" className="ml-3 text-sm text-gray-900">Purple</label>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="pt-6" id="filter-section-1">
                    <div className="space-y-4 font-bold">
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-category-0" className="ml-3 text-sm text-gray-900">Bridal Khussa</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-category-1" className="ml-3 text-sm text-gray-900">Multani Khussa</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-category-2" className="ml-3 text-sm text-gray-900">Embroidered Khussa</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-category-3" className="ml-3 text-sm text-gray-900"> Leather Khussa</label>
                      </div>
                      <div className="flex items-center">
                        ...
                        <label htmlFor="filter-category-4" className="ml-3 text-sm text-gray-900">Walwet Khussa</label>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-2">
                    <div className="space-y-4 font-bold">
                      <div className="flex items-center">
                        <input id="filter-size-0" name="size[]" defaultValue="2l" type="checkbox" className="h-4 w-4 rounded border-gray-300  text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-size-0" className="ml-3 text-sm text-gray-900 font-b900 foont-bold">2L</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-size-1" name="size[]" defaultValue="6l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-size-1" className="ml-3 text-sm text-gray-900 foont-bold">6L</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-size-2" name="size[]" defaultValue="12l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-size-2" className="ml-3 text-sm text-gray-900 foont-bold">12L</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-size-3" name="size[]" defaultValue="18l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-size-3" className="ml-3 text-sm text-gray-900 foont-bold">18L</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-size-4" name="size[]" defaultValue="20l" type="checkbox" className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-size-4" className="ml-3 text-sm text-gray-900 foont-bold">20L</label>
                      </div>
                      <div className="flex items-center">
                        <input id="filter-size-5" name="size[]" defaultValue="40l" type="checkbox" defaultChecked className="h-4 w-4 rounded border-gray-300 text-indigo-600 focus:ring-indigo-500" />
                        <label htmlFor="filter-size-5" className="ml-3 text-sm text-gray-900 foont-bold">40L</label>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {/* Product grid */}
              <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 sm:col-span-1 md:col-span-2 lg:col-span-3">
            {womenfootwear.filter((x)=>{
        if(search==""){
          return x
        }
    ...
    {/* <img src={x.image} className="rounded-sm h-80 w-full"/> */}
              <Link to={`/footwear/${x.id}`}>
       <div className="relative cursor-pointer">
         <img className="w-full object-cover transition duration-300 ease-in-out transform hover:scale-110 " src={x.image} alt="Placeholder Image" />
         <img className="absolute top-0 left-0 bottom-0 w-full  object-cover transition duration-300 ease-in-out opacity-0 hover:opacity-100  border-2 border-gray-950 rounded-xl" src={x.imagehover} alt="Hover Image" />
      </div>
              </Link>
  ...
  <div className="mt-4 px-5 pb-5">
    <a href="#">
      <h5 className="text-xl font-semibold tracking-tight text-slate-900">{x.title.slice(0,36)}</h5>
    </a>
    ...
    <p>
        <span className="text-xl font-bold text-slate-900">PKR : {x.price}</span>
      </p>
