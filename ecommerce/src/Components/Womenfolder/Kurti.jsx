...
import womenkurti from "../../Api/womemkurti"
...
const Kurti = () => {
  ...
  const [allclothes, setAllclothes] = useState(womenkurti);
  const [prodata, setProdata] = useState(womenkurti);
...
const filtercolor = (curitem) => {
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/kurti" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Women Kurti</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Women Kurti</h1>
               {/* search bar */}
 <div>
 <button className=" bg-gray-400 p-3 rounded">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Printed Kurti')}>Printed Kurti</Button>
                  </div>
                  </li>
                  <li>
                  <Button className="w-72" onClick={()=>filterproduct('Kaftan Kurti')}>Kaftan Kurti</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button  onClick={()=>filterproduct('Khaddar Kurti')}>Khaddar Kurti</Button>
                  </li>
                  <li>
                    <Button  onClick={()=>filterproduct('Flared Kurti')}>Flared Kurti</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72">Anarkali Kurti</Button>
                ...
                <div className="border-b border-gray-200 py-6">
                  ...
                  <div className="pt-6" id="filter-section-0">
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="flex items-center">
                      <button type="button" className=" bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 h-6 w-6 rounded-full  text-center"/>
                      ...
                      <button className="w-6 h-6 rounded-full bg-red-900 " />
                        <label htmlFor="filter-color-5" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Red')}>Red</label>
                      </div>
                      <div className="flex items-center">
                        <button className="w-6 h-6 rounded-full bg-blue-700 " />
                        <label htmlFor="filter-color-3" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
                      ...
                      <button className="w-6 h-6 rounded-full bg-pink-400 " />
                        ...
                        onClick={()=>filtercolor('Pink')}>Pink</label>
                      </div>
   ...
   <div className="relative cursor-pointer">
       <img className="w-full h-80 object-cover transition duration-300 ease-in-out transform hover:scale-110  border-2 border-gray-950 rounded-xl" src={x.image} alt="Placeholder Image" />
       <img className="absolute top-0 left-0 w-full h-full object-cover transition duration-300 ease-in-out opacity-0 hover:opacity-100  border-2 border-gray-950 rounded-xl" src={x.imagehover} alt="Hover Image" />
      </div>
   </Link>
