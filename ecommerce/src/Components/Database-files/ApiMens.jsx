...
<div className="mt-2">
                <div className="relative m-2 rounded-lg bg-white shadow-lg shadow-gray-400">
                    <Link to={"#"}>
                        <img className="rounded-t-lg object-cover h-96 w-full" src={pro.image} alt="product image" />
                    </Link>
  ...
  50 %off
                    ...
                    <div className="mt-4 px-5 pb-5">
                        ...
                        <p>
                 <h5 className="text-xl font-bold mb-2 tracking-tight text-slate-900">{pro.title}</h5>
                        </p>
                        <p><h5 className="text-lg font-semibold tracking-tight mb-3  text-slate-900">{pro.description}...</h5>
                        </p>
                        ...
                        <div className="flex items-center justify-between">
                            <p>
                                <span className="text-2xl text-slate-900"> {pro.price}</span>
                            </p>
