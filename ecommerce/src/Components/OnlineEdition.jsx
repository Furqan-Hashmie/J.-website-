...
import onlineedition from "../Api/onlineeditionapi"
...
const OnlineEdition = () => {
  ...
  const [allclothes, setAllclothes] = useState(onlineedition);
  const [prodata, setProdata] = useState(onlineedition);
  ...
  <ol className="inline-flex items-center space-x-1 md:space-x-2">
    ...
    <li>
      <div className="flex items-center">
        ...
        <Link to="/online" className="text-black hover:text-gray-900 ml-1 md:ml-2 text-md  font-extrabold items-center ">Online Edition</Link>
      </div>
    </li>
      ...
      */}
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900">Online Edition</h1>
                     {/* search bar */}
 <div>
 <button className="cursor-pointer bg-gray-400 p-3 rounded">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <form className="hidden lg:block">
                ...
                <ul role="list" className="space-y-4 border-b border-gray-200 pb-6 text-md font-bold text-gray-900">
                 ...
                 <Button className="w-52" onClick={()=>filterproduct('Girls 3PC')}>Kids Girls 3PC</Button>
                  </div>
                  </li>
                  <li>
                  <Button  onClick={()=>filterproduct('Women Kurti')} className="w-72">Women Kurti</Button>
                  </li>
                  <li>
                  <div className="flex w-[26rem] space-x-1">
               <li>
                    <Button onClick={()=>filterproduct('Women 2PC')}>Women 2PC</Button>
                  </li>
                  <li>
                    <Button onClick={()=>filterproduct('Women 3PC')} className="w-40">Women 3PC</Button>
                  </li>
               </div>
                  </li>
                  <li>
                  <Button className="w-72" onClick={()=>filterproduct('New Arrivals Infants')}>Online Edition Infants</Button>
                  ...
                  <div className="pt-6" id="filter-section-0">
                    ...
                    <div className="flex items-center">
                      ...
                      <button className="w-6 h-6 rounded-full bg-pink-400 " />
                        <label htmlFor="filter-color-5" className="ml-2 mt-0.5 text-md text-gray-900"
                        onClick={()=>filtercolor('Pink')}>Pink</label>
                      </div>
                      <div className="flex items-center">
                      <button className="w-6 h-6 rounded-full bg-orange-700 " />
                        <label htmlFor="filter-color-2" className="ml-2 mt-0.5 text-md text-gray-900 cursor-pointer"
                        onClick={()=>filtercolor('Orange')}>Orange</label>
                      </div>
                      <div className="flex items-center">
  ...
  <div className="mt-4 px-5 pb-5">
    <a href="#">
      <h5 className="text-xl font-semibold tracking-tight text-slate-900">{x.title.slice(0,39)}</h5>
    </a>
